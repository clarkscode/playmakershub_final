...
import { retrieveAcceptedEvents } from "../../database/events";
import AcceptedEventsTable from "./Reusable/AcceptedEventsTable";
...
const AcceptedEvents = () => {
  ...
  const fetchAcceptedEvents = async () => {
    try {
      setRefreshing(true);
      const { data, count } = await retrieveAcceptedEvents(
        currentPage,
        pageSize
      );
