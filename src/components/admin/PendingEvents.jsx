...
import PendingEventsTable from "./Reusable/PendingEventsTable";
import { retrievePendingEvents } from "../../database/events";
...
const PendingEvents = () => {
  ...
  const fetchPendingEvents = async () => {
    try {
      setRefreshing(true);
      const { data, count } = await retrievePendingEvents(
        currentPage,
        pageSize
      );
