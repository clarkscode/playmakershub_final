            ...
            <section className="py-10">
               <div id="about" className="mb-10 flex items-start">
                  ...
                  <p className="text-xl leading-relaxed">
                     The Playmakers-USTP Music Organization, founded by Mark Gonzales in 2013
                     and currently having Engr. Jerry Halibas as a coordinator, is part of the
                     Arts and Culture Division. With its 80 dedicated members, Playmakers -
                     USTP is responsible for organizing and managing participants for
                     music-related campus events such as performances, concerts, and music
                     competitions.
                  </p>
               </div>
               ...
               <div id="events" className="mb-10 flex items-start">
                  ...
                  <p className="text-xl leading-relaxed">
                     Playmakers manages around three to four events each month, which is a
                     significant workload considering the members are also students with
                     academic responsibilities and having a frequency of three times a week
                     practices for an upcoming event. Examples of events include the Opening
                     Act for Intramurals, SwiftiesNight 2023, SCITC General Assembly, and more.
                  </p>
               </div>
            </section>
